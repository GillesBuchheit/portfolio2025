...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0A0100] text-white relative overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-linear-to-r from-transparent via-brand to-transparent"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <Link
                    ...
                    className="group"
                  >
                    <div className="w-10 h-10 border border-white/20 rounded-sm flex items-center justify-center hover:border-brand hover:bg-brand/10 transition-all duration-300">
                      <Icon className="w-5 h-5 text-white/60 group-hover:text-brand transition-colors" />
                    </div>
                  </Link>
                );
              })}
          ...
          <div>
            <h4 className="font-erstoria text-sm tracking-[0.2em] text-brand mb-6 uppercase">
              Navigation
            </h4>
            <ul className="space-y-3">
              <li>
                <Link
                  href="#accueil"
                  className="text-white/60 hover:text-brand transition-colors duration-300 text-sm"
                >
                  Accueil
                </Link>
              </li>
