    ...
    <div className="relative w-full mt-10">
      ...
      <div className="flex flex-wrap gap-3 lg:gap-4 pt-8 justify-center lg:justify-start">
        {uniqueQualities.map((quality, index) => (
          ...
          >
            <div className="absolute inset-0 bg-brand/0 group-hover:bg-brand/5 blur-xl transition-all duration-300" />

            <div className="relative px-6 py-3 bg-white/50 backdrop-blur-sm border border-[#0A0100]/10 shadow-sm hover:shadow-md transition-all duration-300 group-hover:border-brand/30">
              <span className="absolute rounded-full left-3 top-1/2 -translate-y-1/2 w-1.5 h-1.5 bg-brand opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
